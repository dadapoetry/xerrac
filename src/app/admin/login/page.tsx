...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="w-full max-w-sm p-8 border border-gray-800 radical-border">
        <h1 className="text-2xl font-bold text-white mb-2 text-center">Xerrac!</h1>
        <p className="text-sm text-gray-500 mb-8 text-center">Panel d&apos;administració</p>
