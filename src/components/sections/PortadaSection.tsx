...
export function PortadaSection({ section, sumariEntries, issueNumber, pdfUrl }: { section: SectionData; sumariEntries?: SumariEntry[]; issueNumber?: number; pdfUrl?: string }) {
