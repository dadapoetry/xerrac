        ...
        {issueId && (
          <button
            ...
            className="group relative mt-6 inline-flex items-center gap-2.5 px-5 py-2.5 text-[11px] font-bold
              ...
              hover:text-red-400 hover:border-red-400 disabled:opacity-50 disabled:cursor-wait
          ...
          >
            ...
            <span className="absolute inset-0 bg-red-400 group-hover:bg-red-400 transition-colors duration-300" />
              ...
              {downloading ? (
                ...
                <>
                  <span className="relative">
                    Llegeix en PDF
                    <span className="absolute -inset-x-1 bottom-0 h-px bg-red-400 group-hover:bg-red-400
