...
<body><div class="page">
  ...
  <svg width="100%" height="14" style="display:block;flex-shrink:0"><defs><pattern id="saw" width="24" height="14" patternUnits="userSpaceOnUse"><path d="M2,2 L12,13 L22,2 Z" fill="#000" /></pattern></defs><rect width="100%" height="14" fill="url(#saw)" /></svg>
